...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    term: "Service Worker",
    definition:
      "在浏览器后台运行的脚本，可拦截网络请求实现离线缓存、消息推送等功能，是 PWA 的核心技术。",
  },
  {
    term: "Mixed Content",
    definition:
      "混合内容——HTTPS 页面中加载了 HTTP 资源，浏览器会阻止或警告，应升级所有资源为 HTTPS 避免此问题。",
  },
  {
    term: "Source Map",
    definition:
      "源码映射——将压缩/编译后的代码映射回原始源文件的文件，方便在浏览器 DevTools 中调试原始代码。",
  },
  {
    term: "Call Stack",
    definition:
      "调用栈——JavaScript 引擎追踪函数调用顺序的数据结构，报错时显示的堆栈信息指明了错误发生的调用路径。",
  },
  {
    term: "IndexedDB",
    definition:
      "浏览器内置的 NoSQL 数据库，支持存储大量结构化数据和索引查询，适合离线应用和本地数据持久化。",
  },
  {
    term: "Lighthouse",
    definition:
  ...
  },
  {
    term: "Breakpoint",
    definition:
      "断点/响应式断点——CSS 媒体查询中定义的屏幕宽度阈值，页面布局在这些断点处切换以适应不同屏幕尺寸。",
  },
  {
    term: "Hydration",
    definition:
  ...
  },
  {
    term: "CSRF",
    definition:
      "跨站请求伪造——诱导用户在已登录的站点上执行非本意的操作。通过 CSRF Token 或 SameSite Cookie 来防御。",
  },
  {
    term: "CSP",
    definition:
      "内容安全策略——通过 HTTP 头或 meta 标签限制页面可加载的资源来源，是防御 XSS 和代码注入攻击的重要防线。",
  },
  {
    term: "CDN",
    definition:
      "内容分发网络——在全球部署边缘节点，将静态资源缓存到离用户最近的服务器上，大幅降低访问延迟和源站压力。",
  },
  {
    term: "CLS",
    definition:
  ...
  },
  {
    term: "DOM",
    definition:
      "文档对象模型——浏览器将 HTML 解析成的树形结构，JavaScript 通过操作 DOM 来动态修改页面内容和样式。",
  },
  {
    term: "ETag",
    definition:
  ...
  },
  {
    term: "LCP",
    definition:
      "最大内容绘制——页面最大可见元素完成渲染的时间。Core Web Vitals 之一，应控制在 2.5 秒以内。",
  },
  {
    term: "MPA",
    definition:
  ...
  },
  {
    term: "CSR",
    definition:
      "客户端渲染——由浏览器 JavaScript 在客户端动态生成页面内容，交互体验流畅但首屏可能较慢且不利于 SEO。",
  },
  {
    term: "TTFB",
    definition:
      "首字节时间——从浏览器发起请求到收到服务器第一个字节的时间，是衡量服务器和网络响应速度的核心性能指标。",
  },
  {
    term: "XSS",
    definition:
