...
// ── L1 ─────────────────────────────────────
app.get('/demos/l1-1', (c) => c.html(page('Webrex · HTML/CSS/JS', `
...
app.get('/demos/l1-2', (c) => c.html(page('Webrex · Network Timing', `
...
app.get('/demos/l1-3', (c) => {
  ...
  return c.html(page('Webrex · 5 Panels', `
...
app.get('/demos/l1-4', (c) => c.html(page('Webrex · Shortcuts', `
...
// ── L2 — Elements ─────────────────────────
const l2Demo = () => page('Webrex · Elements', `
...
// ── L3 — Console ──────────────────────────
const l3Demo = () => page('Webrex · Console', `
...
// ── L4 — Network ──────────────────────────
const l4Demo = () => page('Webrex · Network', `
...
// ── L5 — Sources ──────────────────────────
const l5Demo = () => page('Webrex · Sources', `
...
const l6Demo = () => {
  return (c: any) => {
    ...
    return c.html(page('Webrex · Application', `
...
// ── L7 — Security ─────────────────────────
const l7Demo = () => page('Webrex · Security', `
...
// ── L8 — Responsive ───────────────────────
const l8Demo = () => page('Webrex · Responsive', `
<style>
...
// ── L9 — Compatibility ────────────────────
const l9Demo = () => page('Webrex · Compatibility', `
...
// ── L10 — Architecture ────────────────────
const l10Demo = () => page('Webrex · Architecture', `
...
const l11Demo = () => page('Webrex · Performance Metrics', `
...
// ── L12 — SPA/SSR ─────────────────────────
const l12Demo = () => page('Webrex · Architecture', `
...
// ── L13 — Protocols ───────────────────────
const l13Demo = () => page('Webrex · Protocols', `
