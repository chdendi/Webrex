...
app.get('/lessons/webrex-demo', (c) => {
  ...
  const sections: Record<string, string[]> = {
    ...
    search: ['<div class="search-bar" data-testid="search-section">', '<h2 class="section-title" data-testid="features-title">'],
    cards: ['<div class="cards" id="cards" data-testid="cards-grid">'],
    table: ['<h2 class="section-title" data-testid="data-title">', '<div class="data-table" data-testid="data-table-section">'],
    form: ['<h2 class="section-title" data-testid="form-title">', '<div class="form-section" data-testid="form-section">'],
